...
class EliminarUsuarioScreen extends Component {
  ...
  static navigationOptions = { header: null }
    ...
    cargarApiUsuario(){
         ...
         return fetch('http://10.52.101.135:45455/api/Usuario/NoVigente')
    ...
    select = (item) => {
        ...
        Alert.alert(
            ...
            [
              ...
              {text: 'Si', onPress: () => this.activarUsuario(item)},
            ],
            { cancelable: false }
          )
    }
    ...
    activarUsuario = (item) => {
        //Fetch
          fetch('http://10.52.101.135:45455/api/Usuario/Activar/' + item, {
            method: 'POST',
            headers: {
          ...
          ToastAndroid.show('Usuario Activado! ' , ToastAndroid.SHORT)
          this.cargarApiUsuario();
        }       
...
export default EliminarUsuarioScreen;