...
class ListarProductoScreen extends Component {
  ...
  static navigationOptions = { header: null }
    ...
    select = (item) => {
        ...
        Alert.alert(
            ...
            [
              ...
              {text: 'Si', onPress: () => this.eliminarProducto(item)},
            ],
            { cancelable: false }
          )
    }
    ...
    eliminarProducto = (item) => {
        ...
        //Fetch
            fetch('http://10.52.101.135:45455/api/Producto/' + item, {
              method: 'POST',
              headers: {
...
export default ListarProductoScreen;