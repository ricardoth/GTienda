...
class EliminarClienteScreen extends Component {
    constructor(props){
    super(props);
        this.state = {
            isLoading: true,
    ...
    cargarApiCliente(){
    //LLama al api
    return fetch('http://10.52.101.135:45455/api/Cliente/NoVigente')
    ...
    select = (item) => {
        ...
        Alert.alert(
            ...
            [
              ...
              {text: 'Si', onPress: () => this.activarCliente(item)},
            ],
            { cancelable: false }
          )
    }
    ...
    activarCliente = (item) => {
        //Fetch
          fetch('http://10.52.101.135:45455/api/Cliente/Activar/' + item, {
            method: 'POST',
            headers: {
          ...
          this.cargarApiCliente();
          ToastAndroid.show('Cliente Activado!', ToastAndroid.SHORT)
        }       
}
...
const styles = StyleSheet.create({
  ...
  export default EliminarClienteScreen;