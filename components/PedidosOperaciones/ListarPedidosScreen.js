...
class ListarPedidosScreen extends Component {
    constructor(props){
    super(props);
        this.state = {
            isLoading: true,
    ...
    select = (item) => {
        ...
        Alert.alert(
            ...
            [
              ...
              {text: 'Si', onPress: () => this.eliminarPedido(item)},
            ],
            { cancelable: false }
          )
    }
    ...
    eliminarPedido = (item) => {
        //alert(this.state.id_producto)
        //Fetch
            fetch('http://10.52.101.135:45455/api/Pedido/' + item, {
              method: 'POST',
              headers: {
            ...
            this.cargarApiPedidos();
            ToastAndroid.show('Pedido Eliminado ' , ToastAndroid.SHORT)
        }       
}
...
const styles = StyleSheet.create({
  ...
  export default ListarPedidosScreen;